        ...
        <div className="h-full flex flex-col w-full">
            ...
            <div className="h-10 bg-[#040405] border-b border-white/10 flex items-center justify-between text-[9px] sm:text-[10px] tracking-widest select-none font-bold uppercase w-full">
                <div className="flex items-center h-full">
                    {/* User Prompt */}
                    <div className="px-3 md:px-4 border-r border-white/10 h-full flex items-center bg-white/5 text-primary/70">
                        admin@portfolio:~
                    </div>
                    ...
                    <button 
                        ...
                        className={`h-full px-3 md:px-4 border-r border-white/10 flex items-center gap-2 transition-colors
                        ...
                        `}
                    >
                        <span className="hidden md:inline">1:</span><span>personnel_file</span>
                        {activeTab === 1 && <span className="text-[8px] animate-pulse hidden md:inline">●</span>}
                    </button>
                    ...
                    <button 
                        ...
                        `}
                    >
                        <span className="hidden md:inline">2:</span><span>telemetry</span>
                        {activeTab === 2 && <span className="text-[8px] animate-pulse hidden md:inline">●</span>}
                    </button>
                    ...
                    <button 
                        ...
                        `}
                    >
                        <span className="hidden md:inline">3:</span><span>developer_journey</span>
                        {activeTab === 3 && <span className="text-[8px] animate-pulse hidden md:inline">●</span>}
                    </button>
                </div>
